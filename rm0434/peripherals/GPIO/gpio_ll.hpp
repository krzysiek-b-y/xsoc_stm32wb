...
// MODER
constexpr gpio::MODER::Data operator<<(gpio::MODER::Flag left_a, gpio::E pin_a)
{
    return static_cast<gpio::MODER::Data>(
        (static_cast<std::uint32_t>(left_a)
         << (static_cast<std::uint32_t>(pin_a) * gpio_moder_descriptor::shift_multiplier)));
}
constexpr gpio::MODER::Data operator<<(gpio::MODER::Mask left_a, gpio::E pin_a)
{
    return static_cast<gpio::MODER::Data>(
        static_cast<std::uint32_t>(left_a)
        << (static_cast<std::uint32_t>(pin_a) * gpio_moder_descriptor::shift_multiplier));
}
constexpr gpio::MODER::Flag operator>>(gpio::MODER::Data left_a, gpio::E pin_a)
{
    return static_cast<gpio::MODER::Flag>(
        (static_cast<std::uint32_t>(left_a) >>
             (static_cast<std::uint32_t>(pin_a) * gpio_moder_descriptor::shift_multiplier) &
...
// OTYPER
constexpr gpio::OTYPER::Data operator<<(gpio::OTYPER::Flag left_a, gpio::E pin_a)
{
    return static_cast<gpio::OTYPER::Data>(
        (static_cast<std::uint32_t>(left_a)
         << (static_cast<std::uint32_t>(pin_a) * gpio_otyper_descriptor::shift_multiplier)));
}
constexpr gpio::OTYPER::Data operator<<(gpio::OTYPER::Mask left_a, gpio::E pin_a)
{
    return static_cast<gpio::OTYPER::Data>(
        (static_cast<std::uint32_t>(left_a)
         << (static_cast<std::uint32_t>(pin_a) * gpio_otyper_descriptor::shift_multiplier)));
}
constexpr gpio::OTYPER::Flag operator>>(gpio::OTYPER::Data left_a, gpio::E pin_a)
{
    return static_cast<gpio::OTYPER::Flag>(
        (static_cast<std::uint32_t>(left_a) >>
             (static_cast<std::uint32_t>(pin_a) * gpio_otyper_descriptor::shift_multiplier) &
...
// OSPEEDR
constexpr gpio::OSPEEDR::Data operator<<(gpio::OSPEEDR::Flag left_a, gpio::E pin_a)
{
    return static_cast<gpio::OSPEEDR::Data>(
        (static_cast<std::uint32_t>(left_a)
         << (static_cast<std::uint32_t>(pin_a) * gpio_ospeedr_descriptor::shift_multiplier)));
}
constexpr gpio::OSPEEDR::Data operator<<(gpio::OSPEEDR::Mask left_a, gpio::E pin_a)
{
    return static_cast<gpio::OSPEEDR::Data>(
        (static_cast<std::uint32_t>(left_a)
         << (static_cast<std::uint32_t>(pin_a) * gpio_ospeedr_descriptor::shift_multiplier)));
}
constexpr gpio::OSPEEDR::Flag operator>>(gpio::OSPEEDR::Data left_a, gpio::E pin_a)
{
    return static_cast<gpio::OSPEEDR::Flag>(
        (static_cast<std::uint32_t>(left_a) >>
             (static_cast<std::uint32_t>(pin_a) * gpio_ospeedr_descriptor::shift_multiplier) &
...
// PUPDR
constexpr gpio::PUPDR::Data operator<<(gpio::PUPDR::Flag left_a, gpio::E pin_a)
{
    return static_cast<gpio::PUPDR::Data>(
        (static_cast<std::uint32_t>(left_a)
         << (static_cast<std::uint32_t>(pin_a) * gpio_pupdr_descriptor::shift_multiplier)));
}
constexpr gpio::PUPDR::Data operator<<(gpio::PUPDR::Mask left_a, gpio::E pin_a)
{
    return static_cast<gpio::PUPDR::Data>(
        (static_cast<std::uint32_t>(left_a)
         << (static_cast<std::uint32_t>(pin_a) * gpio_pupdr_descriptor::shift_multiplier)));
}
constexpr gpio::PUPDR::Flag operator>>(gpio::PUPDR::Data left_a, gpio::E pin_a)
{
    return static_cast<gpio::PUPDR::Flag>(
        (static_cast<std::uint32_t>(left_a) >>
             (static_cast<std::uint32_t>(pin_a) * gpio_pupdr_descriptor::shift_multiplier) &
...
// IDR
constexpr gpio::IDR::Data operator<<(gpio::IDR::Flag left_a, gpio::E pin_a)
{
    return static_cast<gpio::IDR::Data>(
        (static_cast<std::uint32_t>(left_a)
         << (static_cast<std::uint32_t>(pin_a) * gpio_idr_descriptor::shift_multiplier)));
}
constexpr gpio::IDR::Data operator&(gpio::IDR::Data left_a, gpio::E pin_a)
{
    return left_a & (0x1u << (static_cast<std::uint32_t>(pin_a) * gpio_idr_descriptor::shift_multiplier));
}
constexpr gpio::IDR::Flag operator>>(gpio::IDR::Data left_a, gpio::E pin_a)
{
    return static_cast<gpio::IDR::Flag>((static_cast<std::uint32_t>(left_a) >> (static_cast<std::uint32_t>(pin_a) *
                                                                                gpio_idr_descriptor::shift_multiplier) &
                                         0x1u));
...
// ODR
constexpr gpio::ODR::Data operator<<(gpio::ODR::Flag left_a, gpio::E pin_a)
{
    return static_cast<gpio::ODR::Data>(
        (static_cast<std::uint32_t>(left_a)
         << (static_cast<std::uint32_t>(pin_a) * gpio_odr_descriptor::shift_multiplier)));
}
constexpr gpio::ODR::Data operator<<(gpio::ODR::Mask left_a, gpio::E pin_a)
{
    return static_cast<gpio::ODR::Data>(
        (static_cast<std::uint32_t>(left_a)
         << (static_cast<std::uint32_t>(pin_a) * gpio_odr_descriptor::shift_multiplier)));
...
// LCKR
constexpr gpio::LCKR::Data operator<<(gpio::LCKR::Flag left_a, gpio::E pin_a)
{
    return static_cast<gpio::LCKR::Data>(
        (static_cast<std::uint32_t>(left_a)
         << (static_cast<std::uint32_t>(pin_a) * gpio_lckr_descriptor::shift_multiplier)));
...
// AFR
constexpr gpio::AFR::Data operator<<(gpio::AFR::Flag left_a, gpio::E pin_a)
{
    return static_cast<gpio::AFR::Data>(
        (static_cast<std::uint32_t>(left_a)
         << (static_cast<std::uint32_t>(pin_a) * gpio_afr_descriptor::shift_multiplier)));
}
constexpr gpio::AFR::Data operator<<(gpio::AFR::Mask left_a, gpio::E pin_a)
{
    return static_cast<gpio::AFR::Data>(
        (static_cast<std::uint32_t>(left_a)
         << (static_cast<std::uint32_t>(pin_a) * gpio_afr_descriptor::shift_multiplier)));
}
constexpr gpio::AFR::Flag operator>>(gpio::AFR::Data left_a, gpio::E pin_a)
{
    return static_cast<gpio::AFR::Flag>((static_cast<std::uint32_t>(left_a) >> (static_cast<std::uint32_t>(pin_a) *
                                                                                gpio_afr_descriptor::shift_multiplier) &
                                         gpio_afr_descriptor::mask));
...
// MODER
constexpr gpio::MODER::Data operator<<(gpio::MODER::Flag left_a, gpio::H pin_a)
{
    return static_cast<gpio::MODER::Data>(
        (static_cast<std::uint32_t>(left_a)
         << (static_cast<std::uint32_t>(pin_a) * gpio_moder_descriptor::shift_multiplier)));
}
constexpr gpio::MODER::Data operator<<(gpio::MODER::Mask left_a, gpio::H pin_a)
{
    return static_cast<gpio::MODER::Data>(
        static_cast<std::uint32_t>(left_a)
        << (static_cast<std::uint32_t>(pin_a) * gpio_moder_descriptor::shift_multiplier));
}
constexpr gpio::MODER::Flag operator>>(gpio::MODER::Data left_a, gpio::H pin_a)
{
    return static_cast<gpio::MODER::Flag>(
        (static_cast<std::uint32_t>(left_a) >>
             (static_cast<std::uint32_t>(pin_a) * gpio_moder_descriptor::shift_multiplier) &
...
// OTYPER
constexpr gpio::OTYPER::Data operator<<(gpio::OTYPER::Flag left_a, gpio::H pin_a)
{
    return static_cast<gpio::OTYPER::Data>(
        (static_cast<std::uint32_t>(left_a)
         << (static_cast<std::uint32_t>(pin_a) * gpio_otyper_descriptor::shift_multiplier)));
}
constexpr gpio::OTYPER::Data operator<<(gpio::OTYPER::Mask left_a, gpio::H pin_a)
{
    return static_cast<gpio::OTYPER::Data>(
        (static_cast<std::uint32_t>(left_a)
         << (static_cast<std::uint32_t>(pin_a) * gpio_otyper_descriptor::shift_multiplier)));
}
constexpr gpio::OTYPER::Flag operator>>(gpio::OTYPER::Data left_a, gpio::H pin_a)
{
    return static_cast<gpio::OTYPER::Flag>(
        (static_cast<std::uint32_t>(left_a) >>
             (static_cast<std::uint32_t>(pin_a) * gpio_otyper_descriptor::shift_multiplier) &
...
// OSPEEDR
constexpr gpio::OSPEEDR::Data operator<<(gpio::OSPEEDR::Flag left_a, gpio::H pin_a)
{
    return static_cast<gpio::OSPEEDR::Data>(
        (static_cast<std::uint32_t>(left_a)
         << (static_cast<std::uint32_t>(pin_a) * gpio_ospeedr_descriptor::shift_multiplier)));
}
constexpr gpio::OSPEEDR::Data operator<<(gpio::OSPEEDR::Mask left_a, gpio::H pin_a)
{
    return static_cast<gpio::OSPEEDR::Data>(
        (static_cast<std::uint32_t>(left_a)
         << (static_cast<std::uint32_t>(pin_a) * gpio_ospeedr_descriptor::shift_multiplier)));
}
constexpr gpio::OSPEEDR::Flag operator>>(gpio::OSPEEDR::Data left_a, gpio::H pin_a)
{
    return static_cast<gpio::OSPEEDR::Flag>(
        (static_cast<std::uint32_t>(left_a) >>
             (static_cast<std::uint32_t>(pin_a) * gpio_ospeedr_descriptor::shift_multiplier) &
...
// PUPDR
constexpr gpio::PUPDR::Data operator<<(gpio::PUPDR::Flag left_a, gpio::H pin_a)
{
    return static_cast<gpio::PUPDR::Data>(
        (static_cast<std::uint32_t>(left_a)
         << (static_cast<std::uint32_t>(pin_a) * gpio_pupdr_descriptor::shift_multiplier)));
}
constexpr gpio::PUPDR::Data operator<<(gpio::PUPDR::Mask left_a, gpio::H pin_a)
{
    return static_cast<gpio::PUPDR::Data>(
        (static_cast<std::uint32_t>(left_a)
         << (static_cast<std::uint32_t>(pin_a) * gpio_pupdr_descriptor::shift_multiplier)));
}
constexpr gpio::PUPDR::Flag operator>>(gpio::PUPDR::Data left_a, gpio::H pin_a)
{
    return static_cast<gpio::PUPDR::Flag>(
        (static_cast<std::uint32_t>(left_a) >>
             (static_cast<std::uint32_t>(pin_a) * gpio_pupdr_descriptor::shift_multiplier) &
...
// IDR
constexpr gpio::IDR::Data operator<<(gpio::IDR::Flag left_a, gpio::H pin_a)
{
    return static_cast<gpio::IDR::Data>(
        (static_cast<std::uint32_t>(left_a)
         << (static_cast<std::uint32_t>(pin_a) * gpio_idr_descriptor::shift_multiplier)));
}
constexpr gpio::IDR::Data operator&(gpio::IDR::Data left_a, gpio::H pin_a)
{
    return left_a & (0x1u << (static_cast<std::uint32_t>(pin_a) * gpio_idr_descriptor::shift_multiplier));
}
constexpr gpio::IDR::Flag operator>>(gpio::IDR::Data left_a, gpio::H pin_a)
{
    return static_cast<gpio::IDR::Flag>((static_cast<std::uint32_t>(left_a) >> (static_cast<std::uint32_t>(pin_a) *
                                                                                gpio_idr_descriptor::shift_multiplier) &
                                         0x1u));
...
// ODR
constexpr gpio::ODR::Data operator<<(gpio::ODR::Flag left_a, gpio::H pin_a)
{
    return static_cast<gpio::ODR::Data>(
        (static_cast<std::uint32_t>(left_a)
         << (static_cast<std::uint32_t>(pin_a) * gpio_odr_descriptor::shift_multiplier)));
}
constexpr gpio::ODR::Data operator<<(gpio::ODR::Mask left_a, gpio::H pin_a)
{
    return static_cast<gpio::ODR::Data>(
        (static_cast<std::uint32_t>(left_a)
         << (static_cast<std::uint32_t>(pin_a) * gpio_odr_descriptor::shift_multiplier)));
...
// LCKR
constexpr gpio::LCKR::Data operator<<(gpio::LCKR::Flag left_a, gpio::H pin_a)
{
    return static_cast<gpio::LCKR::Data>(
        (static_cast<std::uint32_t>(left_a)
         << (static_cast<std::uint32_t>(pin_a) * gpio_lckr_descriptor::shift_multiplier)));
...
// AFR
constexpr gpio::AFR::Data operator<<(gpio::AFR::Flag left_a, gpio::H pin_a)
{
    return static_cast<gpio::AFR::Data>(
        (static_cast<std::uint32_t>(left_a)
         << (static_cast<std::uint32_t>(pin_a) * gpio_afr_descriptor::shift_multiplier)));
}
constexpr gpio::AFR::Data operator<<(gpio::AFR::Mask left_a, gpio::H pin_a)
{
    return static_cast<gpio::AFR::Data>(
        (static_cast<std::uint32_t>(left_a)
         << (static_cast<std::uint32_t>(pin_a) * gpio_afr_descriptor::shift_multiplier)));
}
constexpr gpio::AFR::Flag operator>>(gpio::AFR::Data left_a, gpio::H pin_a)
{
    return static_cast<gpio::AFR::Flag>((static_cast<std::uint32_t>(left_a) >> (static_cast<std::uint32_t>(pin_a) *
                                                                                gpio_afr_descriptor::shift_multiplier) &
                                         gpio_afr_descriptor::mask));
